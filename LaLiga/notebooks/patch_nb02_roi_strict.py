...
# --- STRICT ROI OBJECTIVE FUNCTION (USER REQUESTED) ---
# Features:
# 1. Kelly 25% + Max Stake 5%
# 2. EV Threshold > 10% (0.10)
# 3. Max Odds <= 6.0
# 4. Only 1 bet per match (Best EV)
...
def fix_notebook():
    ...
    if target_idx != -1:
        print(f"Found objective function at cell {target_idx}. Updating with Strict ROI Logic...")
        nb.cells[target_idx] = nbformat.v4.new_code_cell(NEW_OBJECTIVE_CODE)
        nbformat.write(nb, NOTEBOOK_PATH)
        print("✅ Notebook patched: STRICT ROI LOGIC APPLIED.")
    else:
